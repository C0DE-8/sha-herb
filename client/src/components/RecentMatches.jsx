...
export function RecentMatches({ herbs = [], onOpenHerb }) {
  ...
  return (
    <section className="matches-card" id="my-herbs">
      <div className="card-heading matches-heading"><div><p className="section-kicker">YOUR PERSONAL COLLECTION</p><h2>Recently identified</h2></div><Link to="/my-herbs" className="text-link matches-link">My Herbs <span>→</span></Link></div>
