export function Header({ active = 'Overview', onScan }) {
  return (
    <header className="topbar">
      <a className="brand" href="#overview" aria-label="Herbly home">
      ...
      <nav className="main-nav" aria-label="Main navigation">
        <a className={active === 'Overview' ? 'nav-active' : ''} href="#overview">Overview</a>
        <a className={active === 'My Herbs' ? 'nav-active' : ''} href="#my-herbs">My Herbs</a>
        <button className="nav-scan" onClick={onScan}>Scan</button>
        <a className={active === 'Insights' ? 'nav-active' : ''} href="#insights">Insights</a>
      </nav>
